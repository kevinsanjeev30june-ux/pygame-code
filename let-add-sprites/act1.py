...
class Sprite(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # check for collision with left or roight boundaries and reverse direction
        ...
        # If a boundary was hit , post events to change the colorss
        if boundary_hit:
    ...
    def change_color(self):
                self.image.fill(random.choice([GREEN, BROWN ,PURPLE, DARKBLUE]))

# Function to change the background color
def change_background_color():
  global bg_color
  bg_color = random.choice([BLUE, RED, YELLOW])

  # Create a group to hold the sprite
all_sprites_list = pygame.sprite.Group()
# Instantiate the sprite
sp1 = Sprite(DARKBLUE, 20, 30)
